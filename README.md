...
- **当前开发**：v0.2b 记忆蒸馏与治理验收通过（分支 `v0.2b`，tag `v0.2b`；MemoryCore + ExperienceManager + Skill 生命周期；规划见 `v0.2b_MVP_实施规划.md`）
- **历史版本**：v0.2a 三引擎管道（tag `v0.2a`；[P-12] 30/31）｜v0.1 MVP（tag `v0.1`；[P-07] 10/10）
