...
| P-127 | 知识问答抓取正文进合成的单页存储上限 | 4000字符 | numeric | provisional@2026-08-28 | |
| P-128 | Stage 5 网页正文单篇注入 prompt 上限 | 3000字符 | numeric | provisional@2026-08-28 | | 
| P-129 | light 档 LLM fallback 链总预算（分类等轻任务，快模型短预算） | 5000ms | numeric | provisional@2026-08-28 | |
| P-130 | heavy 档 LLM fallback 链总预算（v4-pro 等推理模型合成放宽到单客户端超时上限） | 30000ms | numeric | provisional@2026-08-28 | |
| P-131 | 证据多样性约束：同域名 + 标题/正文 token Jaccard 同质阈值 | 0.6 | numeric | provisional@2026-08-28 | |
