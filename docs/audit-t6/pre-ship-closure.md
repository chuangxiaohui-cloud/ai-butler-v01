...
> 状态：✅ v2.6 pre-ship 收口闭环 + owner 封版确认（2026-09-01）
...
| # | 项 | 建议 | 阻塞 |
|---|---|---|---|
| 1 | tag `v2.6-pre-ship-2026-09-01` + ZIP 封版 | ✅ owner 已封版（2026-09-01「按1、2接着干」）；tag `v2.6-pre-ship-2026-09-01` + ZIP SHA256 见 §4.1 | — |
