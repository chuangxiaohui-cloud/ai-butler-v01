...
## 明天继续（按优先级）
1. provisional 复验数据包已产出（E196 + bench:B-20260822-08，docs/plans/2026-08-22-provisional-review.md）：
   [P-16]/[P-17] PASS 候选（E8/E10 校准 n=93，样本时效待确认）、[P-80]/[P-81] 校准一致（reject n=7<15）、
   [P-63] 政策稳定 9 天待转定稿、[P-105]-[P-107]/[P-82]-[P-94] 样本不足维持、[P-01] 语义与 [P-17]
   重叠待决策、[P-06]/[P-15] 实测超预算（Stage5>8s 30.9%、总>12s 27.3%）需三选一、[P-13] 未落地维持——
   待 owner 按决策清单签认后逐项执行晋升（改 §5 状态 + 附录 A + 代码值同步）。
