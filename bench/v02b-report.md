...
| 模块测试 | 123/123 单测全绿（含实体变体、答案覆盖门控、软件官方源识别、错误主题/FAQ 降权、Experience/Skill 注入、Skill 深度输出、Skill 安装器、三层意图路由、执行器注册表、LLM 特征提取、工作记忆消歧、查询改写、子搜索循环等新增用例） |
...
- v0.2b 已打 tag；后续变更按附录 A 登记（E7-E25 已入档）。
